...
//									.setSmallIcon(android.R.drawable.ic_menu_manage)
		...
		Intent resultIntent = new Intent(context, AirlineOptionActivity.class); // create explicit intent for activity in app
	    ...
	    if (Build.VERSION.SDK_INT >= 16) {
	    	...
	    	stackBuilder.addParentStack(AirlineOptionActivity.class); //adds the back stack for the intent (but not the intent itself)
